...
namespace _13_05_18_InventorySystem2.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "OrderId,OrderDate,ProductId,CustomerId,Quantity,UnitPrice,TotalPrice,AddedBy")] Order order)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "OrderId,OrderDate,ProductId,CustomerId,Quantity,UnitPrice,TotalPrice,AddedBy")] Order order)
        {
            if (ModelState.IsValid)
            {
